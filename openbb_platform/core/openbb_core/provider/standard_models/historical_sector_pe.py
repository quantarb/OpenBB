"""Historical Sector P/E Ratio Standard Model."""
...
class HistoricalSectorPEQueryParams(QueryParams):
    """Historical Sector P/E Ratio Query."""
...
class HistoricalSectorPEData(Data):
    """Historical Sector P/E Ratio Data."""

"""Historical Industry P/E Ratio Standard Model."""
...
class HistoricalIndustryPEQueryParams(QueryParams):
    """Historical Industry P/E Ratio Query."""
...
class HistoricalIndustryPEData(Data):
    """Historical Industry P/E Ratio Data."""
